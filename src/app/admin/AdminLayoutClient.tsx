    ...
    <div className="min-h-screen bg-gray-100 flex items-center justify-center p-4">
      <div className="bg-white rounded-2xl shadow-xl p-8 w-full max-w-md">
        <div className="flex flex-col items-center mb-8">
          <div className="w-16 h-16 bg-[#163c6f] rounded-2xl flex items-center justify-center mb-4">
            <Mountain className="w-8 h-8 text-white" />
          </div>
          <h1 className="text-2xl font-bold text-[#163c6f]">Adria Ski Admin</h1>
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          <div>
            ...
            <div className="relative">
              ...
              <input
                ...
                className="w-full pl-10 pr-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-[#00c0f7] focus:border-transparent outline-none transition"
          ...
          <button
            type="submit"
            disabled={loading}
            className="w-full bg-[#163c6f] text-white py-3 rounded-lg font-semibold hover:bg-[#1a4a87] transition disabled:opacity-50 disabled:cursor-not-allowed"
          >
...
const allNavItems = [
  ...
  { href: "/admin/skijaliste", label: "Skijalište & Kamere", icon: Mountain, permission: null },
...
export default function AdminLayoutClient({ children }: { children: ReactNode }) {
  ...
  return (
    <div className="min-h-screen bg-gray-100 flex overflow-x-hidden w-screen max-w-full">
      ...
      {/* Sidebar */}
      <aside
        className={`fixed lg:static inset-y-0 left-0 z-50 w-64 bg-[#163c6f] text-white flex flex-col transition-transform duration-300 ${
        ...
        <div className="p-6 border-b border-white/10">
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-3">
              <Mountain className="w-8 h-8 text-[#00c0f7]" />
              <div>
                <h2 className="font-bold text-lg leading-tight">Adria Ski</h2>
        ...
        <div className="p-4 border-t border-white/10">
          ...
          {adminUser && (
            <div className="flex items-center gap-3 px-4 py-3 mb-2">
              <div className="w-8 h-8 bg-[#00c0f7] rounded-full flex items-center justify-center text-white text-sm font-bold">
