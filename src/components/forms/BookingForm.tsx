...
export default function BookingForm() {
  ...
  const inputClass = "w-full rounded-lg border border-gray-200 px-4 py-3 text-sm text-[#3d3d3d] bg-white focus:outline-none focus:ring-2 focus:ring-[#00c0f7]/30 focus:border-[#00c0f7] transition-all";
  const labelClass = "block text-xs font-semibold text-[#163c6f] mb-1.5 uppercase tracking-wider";
        ...
        {showCalendar && (
          <div className="mt-2 bg-white border border-gray-200 rounded-xl shadow-lg p-3 inline-block">
            <DayPicker
              ...
              endMonth={maxDate}
              classNames={{
                selected: "bg-[#163c6f] text-white",
                range_middle: "bg-[#163c6f]/10",
                today: "font-bold text-[#00c0f7]",
              }}
            />
          </div>
        )}
