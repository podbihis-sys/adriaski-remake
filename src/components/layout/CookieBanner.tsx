...
export default function CookieBanner() {
  ...
  return (
    <div className="fixed bottom-0 left-0 right-0 z-50 p-4 md:p-6">
      <div className="max-w-4xl mx-auto bg-[#163c6f] text-white rounded-2xl shadow-2xl shadow-black/20 p-5 md:p-6 relative">
        ...
        {showSettings && (
          <div className="mb-4 space-y-3 bg-white/5 rounded-lg p-4">
            <div className="flex items-center justify-between">
              ...
              <div className="w-10 h-5 bg-[#00c0f7] rounded-full relative cursor-not-allowed opacity-70">
            ...
            <div className="flex items-center justify-between">
              ...
              <button
                ...
                className={`w-10 h-5 rounded-full relative transition-colors ${analytics ? "bg-[#00c0f7]" : "bg-white/20"}`}
              >
            ...
            <div className="flex items-center justify-between">
              ...
              <button
                ...
                className={`w-10 h-5 rounded-full relative transition-colors ${marketing ? "bg-[#00c0f7]" : "bg-white/20"}`}
              >
        ...
        <div className="flex flex-col sm:flex-row items-stretch sm:items-center gap-2">
          ...
          {showSettings && (
            <>
              ...
              <button
                ...
                className="px-4 py-2.5 border border-[#00c0f7] text-[#00c0f7] hover:bg-[#00c0f7]/10 rounded-lg text-sm font-semibold transition-colors"
              >
                {t("save_settings")}
              </button>
            </>
          ...
          <button
            onClick={acceptAll}
            className="px-5 py-2.5 bg-[#00c0f7] hover:bg-[#00a8d6] text-white rounded-lg text-sm font-semibold transition-colors"
          >
            {t("accept_all")}
          </button>
        </div>
